...
public class PerformanceActivity extends CommonAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Monthname = getIntent().getStringExtra("monthkey");
        ...
        backiconId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PerformanceActivity.this, DashBoadActivity.class);
...
//        yr.setInverted(true);
    ...
    private void setData(JSONArray jsonArray) {
        ...
        BarDataSet set1;
        set1 = new BarDataSet(yVals1, "Weekly Growth");
...
//            dataSets.add(set1);
    ...
    class loadDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(PerformanceActivity.this, "",
